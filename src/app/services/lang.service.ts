...
const TR: Record<Lang, Record<string, string>> = {
  it: {
    ...
    'project.circus-sm.body': "CIRCUS è un progetto editoriale che riflette sul modo in cui oggi osserviamo e consumiamo immagini. Accanto alla rivista, lo sviluppo di un sito web come estensione digitale del progetto, che non replica la rivista cartacea, ma la amplia, offrendo nuovi modi di fruizione e interazione.\n\nIl sito nasce come una rivista digitale, ma si evolve in una piattaforma più ampia che integra contenuti editoriali, un community hub e uno shop. L’obiettivo è creare uno spazio fluido in cui l’utente non si limita a navigare, ma esplora e approfondisce i contenuti in modo naturale.",
  ...
  en: {
    ...
    'project.circus-sm.subtitle': 'Digital magazine',
    'project.circus-sm.body': "CIRCUS is an editorial project that reflects on the way we observe and consume images today. Alongside the magazine, a website was developed as a digital extension of the project — not replicating the print edition, but expanding it, offering new ways of experiencing and interacting with the content.\n\nThe site was conceived as a digital magazine but evolves into a broader platform integrating editorial content, a community hub, and a shop. The goal is to create a fluid space where the user doesn't just browse, but explores and deepens content in a natural way.",
